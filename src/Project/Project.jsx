...
import invTh from '../assets/thumbnails/inventoryTh.png'
import styles from './Project.module.css'

export function Project(){
    const memoryGameDesc = "A dynamic React memory game powered by the PokeAPI, featuring real-time score tracking," +
    " best-score persistence, and fully randomized card layouts. Built with hooks for state management, asynchronous data" +
    " fetching, and responsive UI updates, the game challenges players to select unique Pokemon without repeating choices." +
    " Designed with modular components, clean logic, and a polished interface, this project demonstrates practical React patterns" +
    " and API-driven interactivity."
    ...
    const inventoryProjDesc = "A full-stack inventory management application built with Express, modular routing," +
    " and a structured CRUD architecture. Features include dynamic item creation, category assignment, real-time" +
    " updates, and clean form handling powered by server-side validation. Designed for clarity, maintainability," +
    " and a smooth user workflow, this project demonstrates practical backend logic, organized controllers," +
    " and a scalable data model suitable for real-world inventory systems."
    ...
    return (
        <section className= {styles.projectsSec}>
            <div className={`${styles.projectsSection} ${styles.fadeIn}`}>
                ...
                <ProjectCard title="Inventory Management" description={inventoryProjDesc} stack="Express, Node.js, JavaScript, EJS Templates, CSS, PostgreSql, MVC Architecture, Railway" thnail={invTh} thAlt="Inventory project Thumbnail" demoLink="https://odininventoryexpress-production.up.railway.app/" githubLink="https://github.com/carlDguez19/odinInventoryExpress" demoIcon={demoIcon} githubIcon={githubIcon} githubAlt="Github link" demoAlt="Demo link" />
                ...
                <ProjectCard title="Memory Game" description={memoryGameDesc} stack="React, Javascript, CSS, Vite, PokeAPI" thnail={pokeMemGame} thAlt="Pokemon Memory Game Thumbnail" demoLink="https://memorygamecarlos.netlify.app/" githubLink="https://github.com/carlDguez19/odinMemoryGame" demoIcon={demoIcon} githubIcon={githubIcon} githubAlt="Github link" demoAlt="Demo link" />
                <h2 className={styles.projectHeader}>Side Projects</h2>
                <div className={styles.sideProjGrid}>
                    <ProjectCard small title="Battleship" stack="Javascript, CSS, HTML, Netlify" thnail={battleshipTh} thAlt="Battleship Thumbnail" demoLink="https://battleship-carlos.netlify.app/" githubLink="https://github.com/carlDguez19/odinBattleship2" demoIcon={demoIcon} githubIcon={githubIcon} githubAlt="Github link" demoAlt="Demo link"/>
                    <ProjectCard small title="SQLZoo Mastery Repository" stack="SQL, PostgreSQL(syntax-compatible), SQLZoo problem sets" thnail={sqlzooTh} thAlt="sqlzoo repo Thumbnail" githubLink="https://github.com/carlDguez19/odinSqlPractice" githubIcon={githubIcon} githubAlt="Github link"/>
