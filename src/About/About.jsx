export function About() {
  return (
    <section className="aboutSection">
      ...
      <div className="aboutBlock">
        <h2 className="aboutTitle">My Path Into Development</h2>
        <p className="aboutText">
          In 2023, I experienced a major health event that required me to rebuild many
      ...
      <div className="aboutBlock">
        <h2 className="aboutTitle">Resilience and Growth</h2>
        <p className="aboutText">
      ...
      {/* HOW I WORK */}
      <div className="aboutBlock">
        <h2 className="aboutTitle">How I Work</h2>
        <p className="aboutText">
      ...
      {/* OUTSIDE OF CODE */}
      <div className="aboutBlock">
        <h2 className="aboutTitle">Outside of Code</h2>
        <p className="aboutText">
          I’m someone who values creativity and rhythm in my life. I enjoy
          world‑building, orchestral soundtracks, reading, cooking, and building
